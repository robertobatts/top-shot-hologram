...
export default class UploadPage extends React.Component {
      ...
      <div>
        ...
        <div>
          ...
          <Button
            ...
            disabled={false/*this.state.isUploadDisabled*/}
            onClick={() => this.upload()}
          >
            Upload
          </Button>
  ...
  updateUploadDisabled() {
    var disabled = this.state.photo1 == null || this.state.photo2 == null || this.state.photo3 == null || this.state.photo4 == null ||
      this.state.photo5 == null || this.state.video == null || this.state.playerName;
    this.setState({ "isUploadDisabled": disabled });
    //TODO set success
  }

  upload() {
    var files = [this.state.photo1, /*this.state.photo2, this.state.photo3, this.state.photo4, this.state.photo5,*/ this.state.video ]
